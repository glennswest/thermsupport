...
(library Library_1
	...
	(symbolDef "RCLAMP1654P_TCT" (originalName "RCLAMP1654P_TCT")
		...
		(pin (pinNum 4) (pt 600 mils -800 mils) (rotation 90) (pinLength 200 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 625 mils -570 mils) (rotation 90]) (justify "Left") (textStyleRef "Default"))
		))
	...
	(compDef "RCLAMP1654P.TCT" (originalName "RCLAMP1654P.TCT") (compHeader (numPins 7) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "DM") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "DP") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "USB ID") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VBUS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "NC_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "NC_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RCLAMP1654P_TCT"))
		...
		(attr "Datasheet Link" "https://www.arrow.com/en/products/rclamp1654p.tct/semtech")
		(attr "Height" "0.65 mm")
	)
